...
#define STRING_CONFIG_H_AUTHOR "(Samith Khin, ProtoDSGN)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ProtoDELTA"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 450.98             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 830 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 */
#define DEFAULT_ACCELERATION          9000    // X, Y, Z and E acceleration for printing moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -3.6, -22.60 }
